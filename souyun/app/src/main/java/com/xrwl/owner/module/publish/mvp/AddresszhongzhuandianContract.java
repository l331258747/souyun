 ...
 */
public interface AddresszhongzhuandianContract {
    interface IView extends BaseMVP.IBaseView<List<Address2zhongzhuandian>> {
    ...
    interface IModel {
        Observable<BaseEntity<List<Address2zhongzhuandian>>> getData(Map<String, String> params);
