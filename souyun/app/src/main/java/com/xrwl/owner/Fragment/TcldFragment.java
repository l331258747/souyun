 ...
 * Use the {@link TcldFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TcldFragment extends BaseEventFragment<PublishContract.IView, PublishPresenter> implements PublishContract.IView {
...
//    public static TcldFragment newInstance(String param1, String param2) {
//        TcldFragment fragment = new TcldFragment();
...
//    }
    ...
    public static TcldFragment newInstance(MarkerBean myLocation, MarkerBean destination,HomeChexingBean chexing, HomeHuowuBean huowu) {
        TcldFragment fragment = new TcldFragment();
        Bundle args = new Bundle();
    ...
    protected void initView(View view) {
        ...
        mPublishBean.category = CategoryDialog.CategoryEnum.TYPE_SHORT.getValue();

        mpublishStartPhonepersonEt.setText(mAccount.getNameDecode());
        mpublishStartPhoneEt.setText(mAccount.getPhone());

        mPhotoScrollView.setOnSelectListener(v -> PictureSelector.create(TcldFragment.this).openGallery(PictureMimeType.ofImage())
                .maxSelectNum(4)
