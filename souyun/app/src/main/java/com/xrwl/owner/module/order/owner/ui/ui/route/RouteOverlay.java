package com.xrwl.owner.module.order.owner.ui.ui.route;
...
public class RouteOverlay {
	...
	protected BitmapDescriptor getStartBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(R.drawable.amap_start2);
	}
	/**
	...
	protected BitmapDescriptor getEndBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(R.drawable.amap_end2);
	}
	/**
	...
	protected void addStartAndEndMarker2() {
		...
		endMarker = mAMap.addMarker((new MarkerOptions()).position(endPoint)
				.icon(getDriveBitmapDescriptor()).title("\u7EC8\u70B9"));
		// mAMap.moveCamera(CameraUpdateFactory.newLatLngZoom(startPoint,
		// getShowRouteZoom()));
	}
	/**
