package com.xrwl.owner.module.order.owner.ui.ui.basic;
...
import static com.xrwl.owner.R.drawable;
import static com.xrwl.owner.R.id;
...
public class LocationActivity extends AppCompatActivity implements AMapLocationListener, GeocodeSearch.OnGeocodeSearchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = (TextView) findViewById(id.text_map);
    ...
    private void initMap() {
        if (aMap == null) {
            ...
            geoMarker = aMap.addMarker(new MarkerOptions().anchor(0.5f, 0.5f)
                    .icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getResources(), drawable.punch_dw))));
        }
