...
public class CompNsViewGroup extends ViewGroup {
    ...
    public CompNsViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CompNsViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
